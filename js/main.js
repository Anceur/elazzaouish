...
document.querySelectorAll('.wrap-icon img').forEach(function(img) {
   const gifSource = img.getAttribute('data-gif');  // Get GIF path from data attribute
   const staticSource = img.src; // Store the static image source
 
   img.addEventListener('mouseenter', function() {
     img.src = gifSource; // Change to GIF on hover
   });
 
   img.addEventListener('mouseleave', function() {
     img.src = staticSource; // Revert to static image when hover ends
   });
 });
